...
import { SidebarCategory, SidebarCategoryGr, SidebarCol, SidebarDesc, SidebarGroup, SidebarInner, ToggleDrop } from './style'
    ...
    >
      <SidebarInner style={{ height: showItemSidebar ? "120px" : "20px", marginBottom: userRoleId === "1" ? "10px" : "30px" }}>
        ...
        >
          ...
          <Dropdown.Menu
            style={{ backgroundColor: "#8000ff", border: "none", marginLeft: isOpen ? "0px" : "10px" }}
          >
      ...
      <SidebarInner style={{ height: userRoleId === "1" ? "0px" : showItemSidebar1 ? "120px" : "20px", marginBottom: userRoleId === "1" && userRoleId === "2" ? "0px" : "30px" }}>
        ...
        >
          ...
          <Dropdown.Menu
            style={{ backgroundColor: "#8000ff", border: "none", marginLeft: isOpen ? "0px" : "30px" }}
          >
